...
if TRAIN_YOLO_TINY:
    print('I am training a tiny model...')
...
def main():
    ...
    # TRAIN_EPOCHS_test=3
    TRAIN_EPOCHS_test=TRAIN_EPOCHS # import from yolov3.configs
    ...
    total_steps = TRAIN_EPOCHS_test * steps_per_epoch
    ...
    for epoch in range(TRAIN_EPOCHS_test):
